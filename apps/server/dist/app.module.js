...
const reaction_entity_1 = require("./recordings/entities/reaction.entity");
const comment_entity_1 = require("./recordings/entities/comment.entity");
        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    entities: [user_entity_1.User, recording_entity_1.Recording, reaction_entity_1.Reaction, comment_entity_1.Comment],
                    synchronize: false,
                    ssl: {
