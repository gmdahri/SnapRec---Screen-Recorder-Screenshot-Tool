                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center justify-center size-20 rounded-[2px] bg-[var(--sr-cyan)]/10 mb-6">
                            <span className="material-symbols-outlined text-[var(--sr-cyan-on-light)] text-5xl">mail</span>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                        ...
                        <a
                            ...
                            className="group block bg-[var(--sr-surface-paper)] rounded-[2px] border border-[var(--sr-border-light-soft)] p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                        >
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0 size-14 rounded-[2px] bg-[var(--sr-cyan)]/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <span className="material-symbols-outlined text-[var(--sr-cyan-on-light)] text-3xl">email</span>
                                </div>
                                <div>
                                    <h2 className="text-xl font-bold text-[var(--sr-text-primary-on-light)] mb-2 group-hover:text-[var(--sr-cyan-on-light)] transition-colors">Email Us</h2>
                                    <p className="text-[var(--sr-text-faint-on-light)] text-sm mb-3">
                                        Best for general questions, feature requests, partnership inquiries,
                                        or anything else.
                                    </p>
                                    <span className="text-[var(--sr-cyan-on-light)] font-semibold text-sm">
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0 size-14 rounded-[2px] bg-[var(--sr-surface-carbon)]/5 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <svg className="size-7 text-[var(--sr-text-primary-on-light)]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" /></svg>
                                </div>
                                <div>
                                    <h2 className="text-xl font-bold text-[var(--sr-text-primary-on-light)] mb-2 group-hover:text-[var(--sr-cyan-on-light)] transition-colors">Report a Bug</h2>
                                    <p className="text-[var(--sr-text-faint-on-light)] text-sm mb-3">
                                        Found something broken? Open a GitHub issue and we'll fix it as
                                        fast as we can.
                                    </p>
                                    <span className="text-[var(--sr-cyan-on-light)] font-semibold text-sm inline-flex items-center gap-1">
                                        Open an Issue
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0 size-14 rounded-[2px] bg-amber-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <span className="material-symbols-outlined text-amber-600 text-3xl">lightbulb</span>
                                </div>
                                <div>
                                    <h2 className="text-xl font-bold text-[var(--sr-text-primary-on-light)] mb-2 group-hover:text-[var(--sr-cyan-on-light)] transition-colors">Suggest a Feature</h2>
                                    <p className="text-[var(--sr-text-faint-on-light)] text-sm mb-3">
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0 size-14 rounded-[2px] bg-green-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <span className="material-symbols-outlined text-green-600 text-3xl">star</span>
                                </div>
                                <div>
                                    <h2 className="text-xl font-bold text-[var(--sr-text-primary-on-light)] mb-2 group-hover:text-[var(--sr-cyan-on-light)] transition-colors">Leave a Review</h2>
                                    <p className="text-[var(--sr-text-faint-on-light)] text-sm mb-3">
                    ...
                    {/* FAQ-style section */}
                    <div className="bg-[var(--sr-surface-panel-light)] rounded-[2px] border border-[var(--sr-border-light-soft)] p-8 md:p-12">
                        <h2 className="text-2xl font-bold text-[var(--sr-text-primary-on-light)] mb-8">Frequently Asked</h2>

                        <div className="space-y-6">
                            <div>
                                <h3 className="font-bold text-[var(--sr-text-primary-on-light)] mb-2">How fast do you respond?</h3>
                                <p className="text-[var(--sr-text-muted-on-light)]">
                            ...
                            <div>
                                <h3 className="font-bold text-[var(--sr-text-primary-on-light)] mb-2">I found a security vulnerability. How should I report it?</h3>
                                <p className="text-[var(--sr-text-muted-on-light)]">
                            ...
                            <div>
                                <h3 className="font-bold text-[var(--sr-text-primary-on-light)] mb-2">Can I contribute to SnapRec?</h3>
                                <p className="text-[var(--sr-text-muted-on-light)]">
                            ...
                            <div>
                                <h3 className="font-bold text-[var(--sr-text-primary-on-light)] mb-2">Do you offer enterprise or team plans?</h3>
                                <p className="text-[var(--sr-text-muted-on-light)]">
