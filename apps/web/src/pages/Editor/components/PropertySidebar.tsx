...
export const PropertySidebar: React.FC = () => {
    ...
    return (
        <aside className="w-72 min-w-[18rem] shrink-0 grow-0 border-l border-[#ece7f4] bg-white flex flex-col overflow-y-auto min-h-[400px]" style={{ contain: 'layout', width: '18rem' }}>
            <div className="p-5 border-b border-[#ece7f4]">
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="space-y-4 pt-2">
                    <div className="space-y-2">
                        ...
                        <input
                            className="w-full h-1.5 bg-[#ece7f4] rounded-full appearance-none accent-primary"
                            type="range"
                            min="1"
                            max="20"
                            value={strokeWidth}
                        ...
                        <div className="grid grid-cols-6 gap-2">
                            {['#8B5CF6', '#ef4444', '#10b981', '#f59e0b', '#3b82f6'].map(color => (
                                <div
                                    ...
                                    className={`size-6 rounded-full cursor-pointer transition-all ${strokeColor === color ? 'border-2 border-white ring-2 ring-primary' : ''}`}
            ...
            <div className="h-[1px] bg-[#ece7f4] mx-5"></div>
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 p-3 rounded-xl border transition-all ${activeTool === 'blur' ? 'bg-primary/10 border-primary text-primary' : 'border-[#ece7f4] hover:bg-background-light'}`}
                    >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 p-3 rounded-xl border transition-all ${activeTool === 'pixelate' ? 'bg-primary/10 border-primary text-primary' : 'border-[#ece7f4] hover:bg-background-light'}`}
                    >
            ...
            <div className="p-4 border-t border-[#ece7f4] h-[200px] min-h-[200px] overflow-hidden shrink-0">
                <GoogleAd
            ...
            <div className="mt-auto p-4 bg-background-light border-t border-[#ece7f4]">
