        ...
        <main>
            ...
            <section className="relative pt-36 pb-16 overflow-hidden">
                <div className="absolute inset-0 -z-10 pointer-events-none">
                    <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[var(--sr-cyan)]/5 rounded-full blur-[120px]" />
                </div>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-8">
                        <div className="flex-shrink-0">
                            <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-[2px] bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center shadow-xl shadow-primary/20">
                                <span className="text-white text-5xl sm:text-6xl font-black">G</span>
                            </div>
                        </div>
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 bg-[var(--sr-cyan-tint)] border border-[var(--sr-cyan)] text-[var(--sr-cyan-on-light)] text-xs font-bold px-3 py-1.5 rounded-full mb-3">
                                <span className="material-symbols-outlined text-sm">verified</span>
                                Creator & Author
                            </div>
                            <h1 className="text-4xl sm:text-5xl font-black tracking-tight mb-3">Ghulam Muhammad</h1>
                            <p className="text-xl text-[var(--sr-text-faint-on-light)] mb-4">Full-Stack Developer · Founder of SnapRec</p>
                            <p className="text-[var(--sr-text-muted-on-light)] leading-relaxed max-w-2xl mb-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--sr-surface-carbon)] text-white text-sm font-semibold rounded-[2px] hover:bg-slate-700 transition-colors"
                                >
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 border border-[var(--sr-border-light-soft)] text-[var(--sr-text-primary-on-light)] text-sm font-semibold rounded-[2px] hover:border-[var(--sr-cyan)] hover:text-[var(--sr-cyan-on-light)] transition-colors"
                                >
            ...
            {/* About / Background */}
            <section className="py-16 bg-[var(--sr-surface-panel-light)]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-2xl font-black mb-8">Background</h2>
                    <div className="prose prose-slate max-w-none text-[var(--sr-text-muted-on-light)] leading-relaxed space-y-4">
                        <p>
            ...
            <section className="py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {expertise.map((item) => (
                            <div key={item.label} className="flex items-start gap-4 p-5 bg-[var(--sr-surface-panel-light)] rounded-[2px] border border-[var(--sr-border-light-soft)]">
                                <div className="w-10 h-10 rounded-[2px] bg-[var(--sr-cyan)]/10 flex items-center justify-center flex-shrink-0">
                                    <span className="material-symbols-outlined text-[var(--sr-cyan-on-light)] text-xl">{item.icon}</span>
                                </div>
                                <div>
                                    <p className="font-black text-[var(--sr-text-primary-on-light)] text-sm mb-0.5">{item.label}</p>
                                    <p className="text-[var(--sr-text-faint-on-light)] text-xs leading-snug">{item.detail}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={item.title} className="flex items-start gap-4 p-6 bg-[var(--sr-surface-paper)] rounded-[2px] border border-[var(--sr-border-light-soft)]">
                                <span className="material-symbols-outlined text-[var(--sr-cyan-on-light)] text-2xl mt-0.5">{item.icon}</span>
                                <div>
                                    <h3 className="font-black text-[var(--sr-text-primary-on-light)] mb-1">{item.title}</h3>
                                    <p className="text-[var(--sr-text-faint-on-light)] text-sm leading-relaxed">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        {authorPosts.map((post) => (
                            ...
                            >
                                ...
                                <h3 className="font-black text-[var(--sr-text-primary-on-light)] text-sm leading-snug mb-2 group-hover:text-[var(--sr-cyan-on-light)] transition-colors">{post.title}</h3>
                                <p className="text-[var(--sr-text-faint-on-light)] text-xs leading-relaxed flex-1 mb-3 line-clamp-2">{post.description}</p>
                                <span className="text-xs text-[var(--sr-text-faint-on-light)]">{post.date}</span>
                            </NavLink>
                        ))}
                    </div>
