                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl">
                    ...
                    <div className="flex justify-center mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-2xl font-bold text-white">SnapRec</h1>
                        </div>
                    </div>
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/60 text-sm">Sign in to access your recordings and screenshots</p>
                    </div>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-gray-800 rounded-xl font-semibold hover:bg-gray-100 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
