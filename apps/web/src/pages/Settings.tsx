                ...
                <div className="max-w-2xl space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <p className="font-bold text-slate-900">{user?.email?.split('@')[0] || 'User'}</p>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="font-semibold text-slate-900">Auto-upload captures</p>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="font-semibold text-slate-900">Copy link after upload</p>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={signOut}
                                className="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold py-3 px-4 rounded-lg transition-colors"
                            >
                                <span className="material-symbols-outlined">logout</span>
                                Sign Out
                            </button>
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 font-bold py-3 px-4 rounded-lg transition-colors"
                            >
