                ...
                <aside className="w-72 bg-white dark:bg-background-dark border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between p-6 overflow-y-auto">
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex items-center gap-3 px-2">
                            ...
                            <div>
                                <h1 className="text-xl font-black tracking-tight text-slate-900 dark:text-white leading-none">SnapRec</h1>
                                <p className="text-primary text-xs font-bold uppercase tracking-widest mt-1">Premium SaaS</p>
                            </div>
                        </div>
                        {/* Main Nav */}
                    ...
                    <header className="h-20 bg-white dark:bg-background-dark border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 shrink-0">
                        <div className="flex-1 max-w-xl">
                            <div className="relative group">
                                ...
                                <input
                                    className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-xl py-2.5 pl-11 pr-4 focus:ring-2 focus:ring-primary/20 text-sm transition-all"
                                    placeholder="Search recordings, tags, or people..."
                                    type="text"
                                />
                            </div>
                        </div>
                        <div className="flex items-center gap-4 ml-8">
                            <button className="size-10 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors relative">
                            ...
                            <div className="flex items-center gap-3 pl-2 cursor-pointer group">
                                ...
                                <div className="size-10 rounded-full border-2 border-slate-100 dark:border-slate-800 overflow-hidden bg-primary/10 flex items-center justify-center">
                    ...
                    <div className="flex-1 overflow-y-auto bg-slate-50/50 dark:bg-background-dark/50">
                        ...
                        <div className="px-8 py-8">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                                ...
                                {/* Empty State Placeholder (Add New) */}
