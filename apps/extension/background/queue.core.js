 ...
 *
 * This is the ESM copy, imported only by the tests. background/queue.js is the
 * classic-script twin that importScripts loads — __tests__/queue.test.js fails
 * if the two drift. */
...
export { enqueue, markUploading, markFailed, markDone, nextPending, backoffMs, prune };
