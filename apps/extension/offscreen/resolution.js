 ...
 *
 * This is the CLASSIC-SCRIPT copy the offscreen document loads.
 * offscreen/resolution.core.js holds the identical bodies for the tests —
 * tests/resolution.test.js fails if the two drift.
 */
...
// Loaded as a classic script before offscreen.js; no module scope here.
globalThis.SnapRecResolution = { RESOLUTION_CAPS, displayConstraints };
