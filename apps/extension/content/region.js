 ...
 *
 * This is the CLASSIC-SCRIPT copy the content script loads. region.core.js
 * holds the identical bodies for the tests — __tests__/region.test.js fails if
 * the two drift. */
...
globalThis.SnapRecRegion = { clampRect, nudge, formatDimensions, magnifierCorner };
